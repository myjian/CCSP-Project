...
var fbLogout = '<a href="/userinfo"><button style="background-color: #5b74a8; color: #FFFFFF">資料</button></a><a href="/logout"><button style="background-color: #5b74a8; color: #FFFFFF">登出</button></a>';
